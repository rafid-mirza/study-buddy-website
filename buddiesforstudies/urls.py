...
urlpatterns = [
    ...
    path('changechats', views.change_chats, name="change_chats"),
    path('refreshfeed', views.refresh_feed, name="refresh_feed"),
    path('sendmessage', views.send_message, name="send_message"),
    path('addparticipant', views.add_participant, name="add_participant"),
    path('addconversation', views.refresh_feed, name="add_conversation"),
